...
| `linkareer_collection` | 링커리어 합격 자소서 | 자소서·면접 준비 질문 | 3개 |
| `senior_collection` | KT 재직 선배 경험담 | 커리어 고민·실무 질문 | 3개 |
...
### 링커리어 자소서 (`linkareer_collection`)

KT 합격 자소서 공개 사례를 링커리어에서 자동 수집합니다.

- 자소서 항목(질문)과 답변 쌍으로 청크해서 저장
- "자소서 1번 어떻게 써?" 질문에 실제 합격 사례를 참고해 답변
...
│    resume → linkareer_collection (합격 자소서)           │
│    advice → senior_collection (선배 경험담)              │
└───────────────────────────┬─────────────────────────────┘
                            │
                            ▼
┌─────────────────────────────────────────────────────────┐
...
```bash
python -m backend.knowledge.crawl_linkareer
```
